...
account_sid = 'AC45da2392fce8b82439721914d6d50dd7'
auth_token = '2efe62ecad075d3031280fd9da140db6'
...
def index():
    if request.method == 'POST':
        ...
        if travel_pass < 30 and request.method =='POST':
            status = 'CONFIRMED'
            client.messages.create(from_='whatsapp:+14155238886',to='whatsapp:+919948639471',
